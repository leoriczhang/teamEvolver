"""Internal SkillGene API for mining Benchmark datasets from trajectories.

This is the application-facing boundary.  SkillGene components should call
...
def mine_benchmark_from_trajectories(
    ...
    *,
    ...
    synchronous because model generation is blocking; async SkillGene
...
async def amine_benchmark_from_trajectories(
    ...
    *,
    ...
    """Async, event-loop-safe variant for SkillGene services and workers."""
