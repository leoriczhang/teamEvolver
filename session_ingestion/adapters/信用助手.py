# Adapter: 信用助手
# Generated from sf_sessions/agents/信用助手.json and agents/_summary.json.
...
SOURCE = {
    ...
    "project_id": 'cmquntkkr02vlxa06hwv4w5d7',
    "enabled": True,
    "max_sessions": 200,
...
TRACE_NAME = 'qualification,qualification_stream,ai_credit_queryRecord,risk,agent-call'
