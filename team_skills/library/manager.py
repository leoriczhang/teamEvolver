...
``description`` (see :mod:`team_skills.library.frontmatter`). All eligible skills
...
from team_skills.library import frontmatter, layout, prompt
from team_skills.library.bundle import list_skill_bundle_paths
from team_skills.library.stats import SkillStats
