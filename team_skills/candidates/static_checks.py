...
from team_skills.library.bundle import candidate_skill_bundle, write_skill_bundle
...
def validate_candidate_bundle(
    ...
    *,
    ...
    try:
        ...
        validate_skill_md(
            bundle.get("SKILL.md", b""),
            expected_name=str(skill.get("name") or ""),
        )
        ...
        checks.append(
            {
                "path": "SKILL.md",
                "checker": "frontmatter_contract",
                "passed": False,
                "detail": detail,
            }
        )
        errors.append(f"SKILL.md: {detail}")
        return {
            "passed": False,
            "enabled": True,
            "checks": checks,
