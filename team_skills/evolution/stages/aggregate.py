"""
Session-level skill aggregation: if ANY interaction in a session explicitly
...
from team_skills.evolution.kernel.enums import NO_SKILL_KEY
...
def aggregate_sessions_by_skill(
    ...
    - Prompt-injected catalog entries are not treated as references; only
      explicit skill reads/modifications should populate ``_skills_referenced``.
    """
