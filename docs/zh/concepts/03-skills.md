...
个人 Skill 可以在「个人与团队资产」中直接编辑。普通用户提交 personal→team 发布申请后，管理员在发布审批中确认；team→personal 复制可用于给个人空间安装团队 Skill。
...
Authorization: Bearer <tevt_租户机器凭证>
```
...
| 验证方式 | True Replay 对比验证 | Memory Replay；聚合内容由聚合 Skill 约束 |
...
| 模块 | 路径 |
|------|------|
| Skill Bundle 模型 | [skills/bundle.py](../../../team_skills/library/bundle.py) |
| 变更服务 | [skills/mutations.py](../../../team_skills/library/mutations.py) |
| 渲染引擎 | [skills/render.py](../../../team_skills/library/render.py) |
| 注册表 | [skills/registry.py](../../../team_skills/library/registry.py) |
| Frontmatter 解析 | [skills/frontmatter.py](../../../team_skills/library/frontmatter.py) |
