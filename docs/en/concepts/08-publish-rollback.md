> Outbox/push sections below describe migration-only history. Strict releases use [Skill pull](../api/06-skill-sync.md): versions and tombstones remain, with no delivery outbox.
...
| Module | Path |
|--------|------|
| SkillMutationService | [skills/mutations.py](../../../team_skills/library/mutations.py) |
| SkillHub (underlying storage ops) | [skills/hub.py](../../../team_skills/library/hub.py) |
...
| Skill ID registry | [skills/registry.py](../../../team_skills/library/registry.py) |
