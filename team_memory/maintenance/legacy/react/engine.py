...
from team_memory.maintenance.legacy.react.planner import TaskPlan, TaskStatus
...
class ReActEngine:
            ...
            if tool_calls:
                ...
                for tc in tool_calls:
                    ...
                    with langfuse_observation(
                        name=f"team_memory.maintenance.legacy.tool.{name}",
                        as_type="tool",
                        input=args,
                        metadata={
                        ...
                        trace_name=(
                            f"team_memory.maintenance.legacy.{plan.job_name}"
                        ),
    ...
    def _call_llm(self) -> Optional[Dict]:
        ...
        with langfuse_observation(
            name=f"team_memory.maintenance.legacy.{job_name}.reason",
            as_type="generation",
            input={
            ...
            trace_name=f"team_memory.maintenance.legacy.{job_name}",
            session_id=self._trace_session_id,
