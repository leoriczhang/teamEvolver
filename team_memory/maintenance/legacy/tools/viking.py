...
from team_memory.maintenance.legacy.config import OpenVikingConfig, parse_openviking_key
from team_memory.maintenance.legacy.policy import team_reference
from team_memory.maintenance.legacy.tools.base import Tool, ToolResult

if TYPE_CHECKING:
    from team_memory.maintenance.legacy.blackboard import Blackboard
    from team_memory.maintenance.legacy.semantic import SemanticMatcher
    from team_memory.memory_changes import (
        MemoryChangeLedger,
