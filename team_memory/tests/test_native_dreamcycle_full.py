...
from team_memory.maintenance.legacy.react.planner import (
    Task,
    TaskPlan,
    TaskStatus,
)
from team_memory.maintenance.legacy.scheduler import Scheduler
from team_memory.maintenance.legacy.tools.base import (
    Tool,
    ToolRegistry,
    ToolResult,
)
...
def test_complete_scheduler_runs_all_five_jobs_and_persists_history(
    ...
    monkeypatch.setattr(
        "team_memory.maintenance.legacy.scheduler.ReActEngine",
        _Engine,
    )
...
def test_full_supervisor_allows_disabling_every_job(tmp_path) -> None:
    ...
    from team_memory.maintenance.integrations.dreamcycle_runtime import (
