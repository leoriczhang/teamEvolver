...
from team_memory import routes as aggregation_routes
...
def test_run_route_accepts_an_independent_target_uri(tmp_path, monkeypatch) -> None:
    ...
    monkeypatch.setattr(service, "submit", fake_run)
    ...
    # Submit is stubbed above: this route test does not execute background I/O.
