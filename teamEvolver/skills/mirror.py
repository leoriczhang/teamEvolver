...
from ..integrations.hermes_delivery import HermesDeliverySpool

logger = logging.getLogger(__name__)

_MIRROR_KIND_PREFIX = "skill_mirror"
_INTEGRATION_ID = "skill-mirror:viking"
...
class VikingSkillMirror:
    ...
    def __init__(
        ...
        *,
        ...
        self._spool = HermesDeliverySpool(path, integration_id=_INTEGRATION_ID)
