...
from .langfuse_mapper import MapperRegistry, build_mapper_registry
...
def preview_sessions(
    ...
    *,
    ...
    if getattr(config, "datasource_type", "") == "skillopt":
...
async def pull_sessions(
    ...
    *,
    ...
    ``agent_id`` optionally loads per-agent hooks from ``adapters/<agent_id>.py``
