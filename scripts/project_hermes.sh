...
HERMES_HOME_DIR="${TEAMEVOLVER_HERMES_HOME:-$ROOT_DIR/team_miner/.hermes_home}"
CONFIG_TEMPLATE="$ROOT_DIR/team_miner/hermes/config.yaml.example"
...
"$ROOT_DIR/.venv/bin/python" \
  "$ROOT_DIR/team_miner/hermes_isolation.py" \
...
unset TEAMEVOLVER_WORKSPACE_TOKEN TEAMEVOLVER_TENANT_TOKEN
